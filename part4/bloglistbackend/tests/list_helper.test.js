...
describe("total likes", () => {
  ...
  test("when list has multiple blog, equals the likes of all the blog", () => {
    const result = listHelper.totalLikes(multipleBlogs)
    expect(result).toBe(36)
  })
  const nothinBlog = []
  test("when list has 0 blog, equals the likes of 0", () => {
    const result = listHelper.totalLikes(nothinBlog)
...
describe("favorite blog", () => {
  ...
  test("when list has multiple blog, equals the likes of most likes", () => {
  ...
  test("when list has 0 blog, equals the likes of {}", () => {
